    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
            ...
            <div style={{ marginBottom: '16px', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
                ...
                />
                <div>
                    <button style={{ backgroundColor: '#3B82F6', color: 'white', padding: '8px 16px', borderRadius: '4px', marginRight: '8px' }}>Add users</button>
                    <button style={{ backgroundColor: '#E5E7EB', color: '#1F2937', padding: '8px 16px', borderRadius: '4px' }}>Upload document</button>
                </div>
            </div>
                        ...
                        {userList.map((row) => (
                            <tr key={row.id} style={{ borderBottom: '1px solid #E5E7EB' }}>
                                ...
                                <td style={{ padding: '12px' }}>
                                    <button onClick={() => openModal(row)} style={{ color: '#3B82F6', fontWeight: 'bold' }}>
                                        ...
                                    </button>
                                </td>
                                <td style={{ padding: '12px' }}>
